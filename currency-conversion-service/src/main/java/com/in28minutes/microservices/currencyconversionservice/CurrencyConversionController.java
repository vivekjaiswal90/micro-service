...
public class CurrencyConversionController {
            ...
            (@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity)
    {
        ...
        ResponseEntity<CurrencyConversionBean> currencyExchangeResponseEntity =
        ...
        CurrencyConversionBean currencyExchangeResponse = currencyExchangeResponseEntity.getBody();
        return  new CurrencyConversionBean
                (currencyExchangeResponse.getId(),
                        from,
                        to,
                        BigDecimal.ONE,
                        currencyExchangeResponse.getConversionMultiple(),
                        quantity.multiply(currencyExchangeResponse.getConversionMultiple()),
                        currencyExchangeResponse.getPort());
    }
}
